...
fn gradient(scalars: &[f32], nx: usize, ny: usize, nz: usize, x: usize, y: usize, z: usize) -> [f32; 3] {
...
fn interp_vertex(iso: f32, p0: [f32; 3], p1: [f32; 3], v0: f32, v1: f32, n0: [f32; 3], n1: [f32; 3]) -> Vertex {
  let denom = v1 - v0;
...
fn polygonise_tetra(out: &mut MeshBuffers, iso: f32, p: [[f32; 3]; 4], v: [f32; 4], n: [[f32; 3]; 4], col: [f32; 4]) {
...
pub fn generate_isosurface_mesh(
  ...
  out.clear();
  mesh_region_append(scalars, nx, ny, nz, iso, color, out, 0, nx - 1, 0, ny - 1, 0, nz - 1, 1);
}
